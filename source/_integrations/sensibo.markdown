...
Once you have made the change to the configuration.yaml file and restared HA, you should find a 'climate' entity corresponding to each Sensibo device in your HA Entities List (for Home Assistant OS, this will be Configuration > Devices and Services > entities (search for climate).
</div>
